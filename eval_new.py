...
def eval(args, model):
    ...
    if args.mode == 0:  # detection only
        ...
        with open('result_target_news.json', 'w') as fp:
            json.dump(result_dict, fp)
        with open('result_pred_news.json', 'w') as fp:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained',
                        default="./weight/SLPNetSave_3/model_best.pth")  # "./weight/pretrained_original/model_best.pth"
