...
def train(args, model):
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        print('args.cuda : {}, is_available : {}, number : {}, name : {}'
              .format(args.cuda, torch.cuda.is_available(), torch.cuda.device_count(), torch.cuda.get_device_name(0)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default="SLPNetSave8") # The save path, under folder -- ./weight
